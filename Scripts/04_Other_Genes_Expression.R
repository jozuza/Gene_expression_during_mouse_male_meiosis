...
# This script takes the single cell and seurat object created on the previous step for other people in the lab to check expressionof their favorite gene(s)
